...
lint/isort: ## check style with flake8
	isort --check psy_transect tests
lint/flake8: ## check style with flake8
	flake8 psy_transect tests
lint/black: ## check style with black
	black --check psy_transect tests
	blackdoc --check psy_transect tests
...
formatting:
	isort psy_transect tests
	black psy_transect tests
	blackdoc psy_transect tests
...
coverage: ## check code coverage quickly with the default Python
	python -m pytest --cov psy_transect --cov-report=html
